...
def create_default_files(server_dir):
    ...
    if not os.path.exists(main_py):
        with open(main_py, 'w', encoding='utf-8') as f:
            f.write('''# TAHMID-CODEX HOSTING - Default Bot
import time

print("=" * 40)
print("Bot is running on TAHMID-CODEX HOSTING")
...
def api_create_server():
    ...
    if not username:
        username = f"TAHMID-CODEX{random.randint(10000, 99999)}"
...
if __name__ == '__main__':
    print("\n" + "=" * 50)
    print("🚀 TAHMID-CODEX HOSTING - FINAL")
    print("=" * 50)
